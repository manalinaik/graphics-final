...
namespace
{
  ...
  //read argv here. set timestepper , step size etc
  void initSystem(int argc, char * argv[])
  {
    // seed the random number generator with the current time
    srand( time( NULL ) );
    system = new FlockSystem(20); // by default use FlockSystem
    timeStepper = new RK4();
    stepSize = .04;	
  }
  ...
  void drawSystem()
  {
    ...
    GLfloat particleColor[] = {0.7f, 0.4f, 0.0f, 1.0f};
    GLfloat floorColor[] = {0.0f, 0.5f, 0.7f, 1.0f};
...
int main( int argc, char* argv[] )
{
    ...
    glutCreateWindow("Final Project: Foids");
